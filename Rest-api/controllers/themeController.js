...
function createTheme(req, res, next) {
    const { themeName, carBrand, carColour, carModel, carYear ,postText } = req.body;
    const { _id: userId } = req.user;

    themeModel.create({ themeName, carBrand, carModel, carColour, carYear ,userId, subscribers: [userId] })
        .then(theme => {
